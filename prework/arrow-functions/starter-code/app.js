...
let sum = (a, b, c, d) =>  a + b + c + d;   // I removed the function word and replace it with an arrow and remove the return word since there is only on line of code inside the function.  
